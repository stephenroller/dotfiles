...
function! s:define_highlights()
  highlight lineAdded    guifg=#009900 guibg=NONE ctermfg=2 ctermbg=bg
  highlight lineModified guifg=#bbbb00 guibg=NONE ctermfg=3 ctermbg=bg
  highlight lineRemoved  guifg=#ff2222 guibg=NONE ctermfg=1 ctermbg=bg
endfunction
